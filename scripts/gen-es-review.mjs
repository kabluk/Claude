...
const REVIEWED = [
  ...
  // connect и prepare вычитаны 16.08, но 18.08 добавлены новые строки
  // (операторы связи; блок плейбука) — вернулись в пакет до проверки.
  // habeas: 18.08 добавлена схема bond-vs-habeas — тоже вернулся.
