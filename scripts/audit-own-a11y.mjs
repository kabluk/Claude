...
const SAMPLE_ROUTES = [
  '/', '/scan/', '/methodology/', '/bfsg-check/', '/checkers/', '/checkers/contrast-checker/', '/checkers/readability-checker/', '/request-quote/', '/agencies/', '/agencies/deque-systems/', '/agencies/tpgi/',
