...
const c: PageContent = {
  ...
  metaTitle: 'Бумаги иммиграционного дела: что означают и что не подписывать · DETNAV',
  metaDesc:
    'Разбор бумаг, которые получает задержанный: повестка NTA, решения, формы к подписи. Что означает каждая и что не подписывать без адвоката. Страница работает без интернета.',
