...
const c: HomeContent = {
  ...
  scenarios: [
    ...
    {
      q: 'BOND',
      h: 'Is there a US citizen or green card holder nearby?',
      a: ['Yes, there is', 'I need to think', 'There is no one'],
      pick: 2,
      t: [
        'Look at bond funds',
        'Nonprofit organizations can post bond for people who have no sponsor.',
  ...
  steps: [
    ...
    },
    {
      ...
      p: 'You can see where you are and what comes next. Fifteen steps from "found him" to court.',
    },
  ],
  dataTitle: 'Your data',
  dataBig: {
  ...
  freeItems: [
    ...
    'Bond: how it works and what not to miss',
