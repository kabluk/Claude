...
const c: JourneyContent = {
  ...
  steps: [
    ...
    { t: 'Sponsor', p: 'Who can post bond, how to ask, what to do when there is no one. A rare path right now.', page: 'sponsor' },
    ...
    { t: 'Bond granted · how to pay', p: 'CeBONDS, form I-352, receipt I-305, bondsmen. Rare, but a real scenario.', page: 'bondpay' },
