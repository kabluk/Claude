...
const c: JourneyContent = {
  title: 'The road',
  lede: 'Twelve steps after the person is found. This is not your plan — it is a map of the process: we show every step that exists. Four are open, the rest are in the works.',
  ...
  steps: [
    ...
    { t: 'Habeas corpus · federal court', p: 'The path release is most often won through now. An attorney prepares and files it.' },
