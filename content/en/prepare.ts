...
const c: PageContent = {
  ...
  blocks: [
    ...
    { kind: 'h2', text: '“What To Do, Step by Step” — a PDF to print and share' },
    {
      kind: 'p',
    ...
    { kind: 'ext', href: '/playbook/detnav-playbook-en.pdf', label: 'Download “What To Do, Step by Step” (PDF, ~25 pages)' },
    ...pwyw,
