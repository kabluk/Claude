...
export const about: PageContent = {
  ...
  blocks: [
    ...
    { kind: 'h2', text: 'Where the data comes from' },
    {
      kind: 'list',
      items: [
        'Facility addresses, ICE offices and stay statistics — ICE data obtained under FOIA and compiled by the Deportation Data Project (University of California)',
        'Courts, forms and procedures — official EOIR, ICE and USCIS pages; each fact links to its primary source',
        'Every page shows a last-checked date; rules change — the primary source always outranks our retelling',
      ],
    },
  ...
  blocks: [
    ...
    { kind: 'h2', text: 'How it works' },
    {
      ...
      items: [
        ...
        'No external requests at all: even the fonts live on our server',
