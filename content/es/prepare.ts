...
const pwyw: Block[] = PWYW_URL
  ? [
      ...
      { kind: 'ext', href: pwywFor('es'), label: 'Apoyar — cualquier cantidad' },
    ]
  : []
...
const c: PageContent = {
  ...
  blocks: [
    ...
    { kind: 'h2', text: '«Qué hacer, paso a paso» — un PDF para imprimir y compartir' },
    {
      kind: 'p',
    ...
    { kind: 'ext', href: '/playbook/detnav-playbook-es.pdf', label: 'Descargar «Qué hacer, paso a paso» (PDF, ~25 páginas)' },
    ...pwyw,
