...
const c: JourneyContent = {
  ...
  steps: [
    ...
    { t: 'Quién paga la fianza', p: 'Quién puede pagarla, cómo pedirlo, qué hacer si no hay nadie. Ahora es un camino poco frecuente.', page: 'sponsor' },
    ...
    { t: 'Dieron fianza · cómo pagar', p: 'CeBONDS, formulario I-352, recibo I-305, fiadores. Poco frecuente, pero real.', page: 'bondpay' },
