...
const c: JourneyContent = {
  title: 'El camino',
  lede: 'Doce pasos después de encontrar a la persona. No es su plan — es un mapa del proceso: mostramos todos los pasos que existen. Cuatro están abiertos, el resto en preparación.',
  ...
  steps: [
    ...
    { t: 'Habeas corpus · corte federal', p: 'El camino por el que más se logra la salida ahora. Lo prepara y lo presenta un abogado.' },
