...
const c: IntakeContent = {
  ui: {
    ...
    evNote: {
      ...
      p: 'Así se marcan las tareas de la lista de factores que, según una decisión publicada de la BIA, se consideran al decidir sobre la fianza: dirección, tiempo de residencia, lazos familiares, trabajo, asistencia a la corte, antecedentes. No evaluamos su situación y no predecimos el resultado — solo enumeramos lo que normalmente se respalda con documentos.',
    },
    zoneBNote: {
      h: 'Lo que sigue — preguntas para el abogado',
      p: 'Año y forma de entrada, casos y órdenes anteriores, detenciones anteriores. Esas respuestas no se muestran en pantalla y no producen conclusiones — van solo al PDF que usted entregará al abogado.',
    },
  ...
  questions: {
    ...
    anum: {
      ...
      hint: 'La letra A y nueve dígitos. Está en el permiso de trabajo, la green card, las cartas de USCIS y de la corte.',
      o: {
        yes: { t: 'Sí, lo sé' },
    ...
    sponsor: {
      ...
      hint: 'El detenido no puede pagar su propia fianza. También pueden ser obligados los bufetes y las organizaciones sin fines de lucro. El propio derecho a la audiencia de fianza está en disputa — esa es una pregunta aparte para el abogado.',
      o: {
  ...
  tasks: {
    ...
    anum_find: {
      ...
      how: [
        ...
        'Cualquier carta de USCIS o de la corte de inmigración',
    ...
    ev_work_cash: {
      ...
      src: [
        ...
        ['La carta de asignación del ITIN, si no hay SSN', 'de su propio archivo de documentos'],
      ],
    },
    ev_work_own: {
      ev: true,
    ...
    bond_first: {
      ...
      how: [
        ...
        'Solo después decida si buscar un obligado',
      ],
    ...
    sponsor_ready: {
      h: 'Prepare los documentos del futuro obligado',
    ...
    sponsor_talk: {
      h: 'Hable con el posible obligado con tiempo',
      p: 'Es una conversación dura; mejor no empezarla el día de la audiencia.',
      why: 'Personas con el estatus adecuado suele haber muy pocas, y la petición es seria — por eso se pospone hasta el final.',
      how: [
      ...
      say: 'Necesito pedirte algo serio. Para que suelten a una persona, la fianza la debe pagar un ciudadano o alguien con green card — yo no puedo hacerlo. El dinero se devuelve cuando termina el caso, pero puede tardar mucho. Entenderé cualquier respuesta. ¿Puedo explicarte cómo funciona?',
      warn: 'No prometa plazos de devolución — no dependen ni de usted ni de él.',
    },
    bondfund: {
      h: 'Mire los fondos de fianza',
      p: 'Las organizaciones sin fines de lucro pueden actuar como obligado.',
      why: 'Si no hay personas adecuadas, el obligado puede ser una organización. Para muchos es el único camino.',
      how: [
    ...
    hipaa: {
      ...
      why: 'Un formulario HIPAA firmado da a la persona de confianza acceso a los registros médicos y a los médicos. Hace falta para la salud y como prueba para el caso.',
