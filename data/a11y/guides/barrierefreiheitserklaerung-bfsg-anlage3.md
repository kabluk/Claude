...
4. **Verbraucherinformationen nach Art. 246 EGBGB** — Identität und Kontaktdaten des Anbieters, wie sie ohnehin aus dem Fernabsatzrecht bekannt sind.
5. **Zuständige Marktüberwachungsbehörde** — die Angabe, wer im Beschwerdefall zuständig ist. Bundesweit ist das die [Marktüberwachungsstelle der Länder für die Barrierefreiheit von Produkten und Dienstleistungen (MLBF)](https://mlbf-barrierefrei.de/) mit Sitz in Magdeburg.

Punkt 3 ist zugleich der Grund, warum unser [BFSG-Check](/bfsg-check/) genau hier ansetzt: Ein automatischer Scan kann WCAG-Verstöße finden, aber nicht beurteilen, ob eine Erklärung fehlt oder unvollständig ist — deshalb prüft er die Erklärung als eigenen, vorrangigen Befund, bevor er überhaupt zu den technischen Details kommt.
