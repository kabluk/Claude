...
**Следующий шаг:** Дни 4–7 (ручная верификация + обогащение: города, цены, сертификаты, описания). Затем Дни 8–12 (MVP-страницы: профиль, страна-хаб, комбо, клиентские фильтры, JSON-LD).
