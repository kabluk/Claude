...
Ниже — 1423 фрагментов по разделам. Отмечать нужно только те, где текст
...
## Se llevaron a alguien · las primeras horas  (`es/playbook.ts`)

- Mapa de este documento
- Todo el camino en una página. Cada punto está explicado en detalle adentro — el número de la sección coincide con el número del punto.
- Se llevaron a alguien · las primeras horas
- Ahora mismo solo importan dos cosas: saber dónde está y no perder su llamada. No firme nada, no le pague a nadie.
- Encontrar dónde está
- localizador de ICE: por número A o por nombre
- Mientras no sepa en qué edificio está, nada más funciona: ni llamadas, ni dinero en la cuenta, ni la visita del abogado. Que la búsqueda salga vacía en las primeras horas es normal: el registro aparece hasta en 72 horas. Vuelva a buscar.
- Preparar su teléfono
- quitar el bloqueo de números desconocidos, volumen al máximo
- Usted no puede llamarlo — solo él puede llamarla, desde un número desconocido. Si su teléfono rechaza a los desconocidos en silencio, su única llamada se pierde.
- Abrir una cuenta de llamadas y ponerle dinero
- GettingOut / Securus / ICSolutions — según el centro
- Las llamadas desde adentro son de paga, y paga usted. Mientras la cuenta esté en cero, él físicamente no puede marcar su número. El dinero en la cuenta es su voz.
- Su primera llamada — con un plan corto
- 3 preguntas en papel: centro · número A · salud
- Los minutos son pocos y la línea se graba. Con las preguntas escritas de antemano, no se va a quedar en blanco, va a saber lo esencial y no va a decir de más.
- El abogado — lo principal · los primeros días
- El gobierno no da un abogado gratuito en los casos de inmigración — lo busca la familia. Con abogado, la gente sale tres veces más seguido.
- Dónde buscar
- AILA (filtro por idioma) · lista pro bono de la corte · organizaciones del estado
- Un abogado puede llevar el caso desde cualquier estado — busque por idioma, no por ciudad. Hay caminos gratuitos y de bajo costo: las listas y los teléfonos están adentro.
- Verificar antes de pagar
- licencia en el registro del estado · 2 minutos
- Con estas desgracias hay quien se aprovecha: toman el dinero y desaparecen. Un «notario» en EE. UU. no es abogado. La verificación toma dos minutos y salva miles de dólares.
- Preparar la primera cita
- paquete de documentos + cronología + número A
- El abogado cobra por horas. Si los papeles ya están juntos y ordenados, trabaja en el caso desde la primera hora, en vez de ordenar su carpeta con su dinero.
- Caminos de salida · se habla con el abogado
- Para salir de la custodia hay dos caminos. Elige el abogado — pero cuando usted conoce los dos, entiende qué está haciendo y puede preguntar por qué eligió ese.
- Bond · fianza
- corte de inmigración (EOIR)
- Dinero como promesa de ir a todas las audiencias. Ahora a categorías amplias no les corresponde audiencia de fianza — esta puerta suele estar cerrada.
- Habeas corpus
- corte federal de distrito
- Una queja ante un juez federal independiente: «revise si es legal que me tengan detenido». Funciona incluso donde negaron la fianza. La presenta un abogado.
- El camino largo · semanas
- La crisis de los primeros días pasó — empieza el maratón. Tres cosas que mantienen a la familia a flote por meses.
- El camino del caso
- 12 pasos desde «lo encontramos» hasta la corte
- El caso dura meses, y lo que más asusta es no saber. El mapa muestra dónde está usted y qué sigue. Regla de hierro: faltar a una audiencia = orden de expulsión en ausencia.
- El plan familiar en papel
- campos para llenar a mano + la tarjeta de derechos
- Si la desgracia se repite, la familia no va a buscar teléfonos en pánico — todo ya está escrito y guardado en casa. Se llena en una tarde.
- Glosario y todos los enlaces
- 45 términos + todas las direcciones en una página
- Palabras como habeas y NTA asustan hasta que se entienden. Y la página de enlaces se puede fotografiar y mandar a un familiar en una sola foto.
- Las primeras horas: encontrarlo, la llamada, el contacto
- La meta de estas horas son dos cosas: saber dónde está y no perder su llamada. No firme nada, no le pague a nadie sin verificar.
- Cómo buscar
...
- Mientras no sepa el centro, nada más funciona: ni llamadas, ni dinero, ni abogado. Y vuelva a buscar aunque lo haya encontrado ayer: a la gente la trasladan entre estados sin avisar a la familia.
- Preparar su teléfono para su llamada
- Hacer ahora mismo
...
- GettingOut — cuenta, llamadas; la aplicación está ahí mismo
- Securus — si el centro usa Securus
- ICSolutions — si el centro usa ICSolutions
- Tres preguntas — anotar las respuestas en papel
...
- De qué no hablar en esta llamada
...
- Los minutos son pocos y la línea se puede cortar. Con las tres preguntas a la vista, no se queda en blanco, averigua lo esencial para buscar abogado y no dice de más en una línea grabada.
- El abogado: encontrar, verificar, preparar la cita
- El gobierno no da un abogado gratuito en los casos de inmigración — lo busca la familia. Es la tarea principal de los primeros días: con abogado, la gente sale tres veces más seguido (42% contra 14%).
- Tres caminos — todos legítimos
...
- Sobre el dinero — preguntar desde el inicio
...
- Buscador de AILA — filtro por idioma
- Los precios de los abogados varían mucho, y en pánico es fácil aceptar cualquier cosa. Tres preguntas sobre el dinero antes de empezar ahorran miles y quitan sorpresas.
...
- Aquí es donde las familias pierden más dinero
...
- Armar el paquete de documentos
...
- Caminos de salida: bond y habeas — cómo funcionan juntos
- Todo como es, sin «cuál es mejor»: elegir el camino es trabajo del abogado. Estas páginas ayudan a entender su lógica y a hacer las preguntas correctas.
- Primero lo primero: de qué depende el plan
- Todo lo determina el artículo de la ley bajo el cual tienen a la persona. Simplificando, hay tres categorías:
...
- Por qué saberlo
- La primera pregunta al abogado: «¿Bajo qué artículo lo tienen?» La respuesta determina si la puerta de la fianza está abierta — o si hay que ir directo a la corte federal.
- Bond · fianza — el análisis completo
- Cuánto es ahora
...
- De qué dependen la cantidad y la decisión
...
- Habeas corpus — el análisis completo
...
- Qué puede y qué no puede el juez
...
- Cómo se conectan — la idea clave
- No es «uno o el otro»
...
- El habeas no es un escudo contra la deportación
...
- «¿Y cuál es mejor?» — la respuesta honesta
- La pregunta «cuál es mejor» no tiene una respuesta general — lo que corresponde depende del artículo de detención, del circuito y de los hechos del caso concreto. Ese es exactamente el trabajo del abogado. Lo nuestro es que usted entienda su plan y pueda preguntar:
- Preguntas al abogado — copiar en papel
...
- Dónde se decide
- corte de inmigración (EOIR, agencia del Depto. de Justicia)
- corte federal de distrito, un juez independiente
- La pregunta
- si lo sueltan con dinero mientras corre el caso
- si es legal tenerlo detenido
- Quién prepara
- un abogado (se puede solo — vea la estadística)
- un abogado con práctica federal
- Costo de entrada
- la cantidad de la fianza, normal $5,000–$10,000 (se devuelve al fiador)
- cuota de $5 + el trabajo del abogado
- Si niegan
- apelación a la BIA; nueva audiencia si algo cambia
- apelación a la corte federal de apelaciones
- Efecto en el caso de expulsión
- no lo resuelve
- no lo resuelve; el stay va aparte
- Fuentes: TRAC Immigration (informes 722, 738), Matter of Guerra (BIA), formulario I-352 de ICE, ILRC (dic. 2025), 28 U.S.C. § 2241, INA § 236. A agosto de 2026 — las reglas cambian; la Corte Suprema toma la pregunta en el otoño de 2026.
- Semanas y meses: el camino y el plan de la familia
- La crisis de los primeros días pasó — empieza el maratón. Aquí está lo que mantiene a la familia a flote por meses.
- El camino del caso — 12 pasos
- Cómo está armado el caso
...
- Lo que más asusta es no saber. Cuando la familia ve el mapa — dónde estamos, qué viene el próximo mes — el pánico se convierte en plan. Y la regla del EOIR-33 evita el desastre más doloroso: perder el caso por una carta a la dirección vieja.
- Qué hay adentro — campos para la pluma
...
- Dinero y propiedad — solo por adelantado
...
- La tarjeta de derechos · llevar consigo (3 idiomas)
...
- El plan con nombres y teléfonos se queda en casa — no en el bolsillo
...
- Se llena en una tarde. Si la desgracia se repite, la familia no busca números en pánico — todo está escrito en casa, y la persona de confianza sabe qué hacer desde la primera hora.
- Todos los enlaces — una página
- Cada dirección de este documento en un solo lugar. Fotografíe esta página y mándela en una sola foto. En la versión digital todo es clicable.
- Oficiales y servicios
- Organizaciones de ayuda por estado
- Páginas de detnav.com con herramientas
