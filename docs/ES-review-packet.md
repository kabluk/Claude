...
## Si algo anda mal  (`es/complaints.ts`)
...
## Formularios y avisos  (`es/forms.ts`)
...
- Vacío no quiere decir que no esté
...
- Por dónde empezar
- Se llevaron a alguien
- Qué hacer en las primeras horas tras una detención repentina.
- Localizar a la persona
- Primera llamada
- Paquete para el abogado
- Arme un PDF ordenado con los documentos — en su propio teléfono.
- Armar el paquete
- Un plan por si acaso
- Una lista de tareas para su situación — en 2 minutos.
- Responder preguntas
- Le ayudamos a:
...
- A NOMBRE DE QUIÉN
- ¿A nombre de quién está la renta?
- De los dos
...
- ¿Quién puede recoger al niño en la escuela?
- Los dos
- Solo él
- No sé
...
- ¿Sabe a qué abogado llamaría si llega el problema?
- Sí, tengo el contacto
- Todavía no
- No sé
...
- En qué ayuda
- Su propia lista de tareas en 2 minutos
- No son consejos generales — son tareas para sus circunstancias. Cada una dice para qué es, cómo hacerla y dónde conseguir las cosas.
- La primera noche sin pánico
- Cómo encontrar a la persona, qué no firmar, a quién no pagar. En lenguaje claro, con lectura en voz alta.
- Un paquete listo para el abogado
- Llegue con los documentos reunidos — pague por el trabajo en el caso, no por ordenar papeles.
- Empezar · 2 minutos
- Primero ver cómo funciona todo
- SIN REGISTRO
- EN · ES · RU
- Tres pasos
- Responde las preguntas
- Sencillas, cada una explica para qué sirve. ¿No sabe la respuesta? Dígalo — es normal.
- Recibe su lista
- No es un consejo general: son tareas para sus circunstancias. Cada una dice para qué es y qué hacer paso a paso.
- Sigue el mapa
- Se ve dónde está y qué sigue. Doce pasos desde «lo encontramos» hasta la corte.
- Sus datos
- No guardamos nada sobre usted
- Las respuestas, las fotos de documentos y su lista se quedan en su teléfono. No se envían a nuestro servidor — ni una palabra, ni un archivo.
...
- No evaluamos su situación y no decimos cómo terminará.
- No recomendamos abogados concretos
- Mostramos los registros oficiales — usted verifica por su cuenta.
- No redactamos documentos
- Explicamos qué hace el documento y señalamos el formulario oficial.
...
## Qué significan los papeles  (`es/documents.ts`)
...
## Para organizaciones  (`es/orgs.ts`)
...
## Notas de estado NY / FL  (`data/states.json`)

- Nueva York: Nueva York tiene un programa de representación con fondos públicos para inmigrantes detenidos (NYIFUP). Confirme la cobertura actual con las organizaciones de abajo. A agosto de 2026.
- Florida: Florida está en el Undécimo Circuito y tiene muchos centros de detención, incluidos Krome y el sitio del sur de Florida. A las personas se las traslada a menudo dentro del estado. A agosto de 2026.
