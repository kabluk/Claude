...
| `G-INDEXNOW` | **Приоритет D-174 (2026-08-15)**: IndexNow-пинг Bing/Yandex при деплое — SEO-INDEXING-PLAN.md п.5 | todo, разблокирован прямо сейчас (узел в GRAPH.yaml), эффект — на следующем деплое |
