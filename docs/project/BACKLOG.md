...
| G-GUIDES | Новые гайды под кластеры BFSG/EAA/VPAT | **in progress** (D-056, D-057): выбран product-lead как более ценный прямо сейчас (контент растит трафик и без реального домена, hreflang — нет). Первый кусок — **done**: гайд `barrierefreiheitserklaerung-bfsg-anlage3` (`G-GUIDES-BFSG-STATEMENT`). Второй кусок — **done** (D-057, `G-GUIDES-EAA-8`): по одному посвящённому гайду для всех 8 юрисдикций D-031, которые были без текста (IT/IE/AT/BE/SE/DK/FI/NO) — все 8 юридических цитат перепроверены живьём, ни одной суммы штрафа (D-035), хаб `european-accessibility-act-guide.md` расширен ссылками на все 8. Остаток НЕ начат: VPAT-кластер (сравнение с EN 301 549 отчётом, факты не проверены), ещё BFSG-контент |
