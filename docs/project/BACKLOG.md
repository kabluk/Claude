...
| CN-COMPONENTS-REST | Остаток библиотеки §22 — по одному образцовому за раз, страница только когда живой пример реален и проходит тот же a11y-порог. **1/10 done: Toast (D-070, 2026-08-08)**. Осталось 9: Tooltip, Combobox, Menu button, Select/listbox, Breadcrumbs, Pagination, Switch, Data table, Form field | frontend-engineer | CN-COMPONENTS | in progress (1/10; по одному, не пачкой) |
