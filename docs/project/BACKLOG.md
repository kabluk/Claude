...
| ID | Задача | Статус |
|---|---|---|
| `G-INTERLINK-AUDIT` | **Приоритет D-174 (2026-08-15)**: аудит внутренней перелинковки 24 гайдов — SEO-INDEXING-PLAN.md п.6. Двигает спрос к воронке `scan→report→request-quote` без деплоя платных ресурсов | todo, разблокирован прямо сейчас (узел в GRAPH.yaml) |
