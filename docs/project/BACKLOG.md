...
| `G-CHECKER-STATEMENT-GEN` | **Кандидат №1 по исследованию рынка (D-179, growth.md)**: Accessibility Statement Generator, форма → готовый HTML. Самый плотный кластер конкурентов (8+ игроков), максимальная близость к воронке | todo (узел в GRAPH.yaml). Числовых данных о спросе нет — сигнал косвенный; risk medium из-за юр-формулировок |
