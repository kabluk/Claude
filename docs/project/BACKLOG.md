...
| CN-COMPONENTS-REST | Остаток библиотеки §22 — по одному образцовому за раз, страница только когда живой пример реален и проходит тот же a11y-порог. **5/10 done: Toast (D-070), Tooltip (D-074), Breadcrumbs (D-077), Combobox (D-078), Menu button (D-079, 2026-08-08)**. Осталось 5: Select/listbox, Pagination, Switch, Data table, Form field | frontend-engineer | CN-COMPONENTS | in progress (5/10; по одному, не пачкой) |
