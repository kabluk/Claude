...
| `G-CHECKER-HTML-PARSER` | **Кандидаты №3-4 (D-179)**: Alt Text Checker + Heading Structure Analyzer на общем DOMParser-движке (вставка HTML — ввод URL невозможен на клиенте из-за CORS). Heading даёт двойной кластер a11y+SEO | todo (узел в GRAPH.yaml). Числовых данных о спросе нет по обоим |
